 ...
 *  - GAIN 3.0% PER DAY forever
 *  
 *  https://www.TronDouble.com
 ***********************************************************/
...
function GetPlanTimeByUid(uint256 uid) public 
    ...
    function invest(uint256 _affCode, uint256 _planId) public payable {
        ...
        if (msg.value >= 1000000) {
            ...
            uint256 devFee = (msg.value.mul(4)).div(100);
            devAddr_.transfer(devFee);
            
            uint256 partnerFee = (msg.value.mul(4)).div(100);
	...
	function withdraw() public payable {
        ...
        for(uint i = 0; i < player_[uid].planCount; i++) {
            ...
            // send calculated amount of trx directly to sender (aka YOU)
