...
contract TronFund is Ownable {
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(10, 300*60*60*24)); //300 days
        investmentPlans_.push(Objects.Plan(16, 125*60*60*24)); //125 days
        investmentPlans_.push(Objects.Plan(26, 60*60*60*24)); //60 days
        investmentPlans_.push(Objects.Plan(36, 35*60*60*24)); //35 days
    }
