...
contract TronRich is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 50; //per thousand
    uint256 public constant MARKETING_RATE = 80;
    ...
    uint256 public constant REFERENCE_LEVEL3_RATE = 40;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(16, 228*60*60*24)); // 228 days
        investmentPlans_.push(Objects.Plan(26, 100*60*60*24)); //100 days
        investmentPlans_.push(Objects.Plan(36, 45*60*60*24)); //45 days
        investmentPlans_.push(Objects.Plan(46, 28*60*60*24)); //28 days
    }
