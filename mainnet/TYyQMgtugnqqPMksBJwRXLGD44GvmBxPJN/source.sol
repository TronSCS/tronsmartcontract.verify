...
/**
 * Triple3ROI Contract
 * Every day generates 33.3% of deposit value, 3 days to get 100% ROI
 */
...
contract Triple3ROI{
    ...
    uint256 public interest = 333;  // 12 hours ROI
    uint256 public minutesElapse = 60*24; // production 60 * 24 
    uint256 public minimum = 1000000; // minimum deposit = 1 trx
   
    uint256 private referralDivRate = 100; // 
    uint256 private devDivRate = 100; // 
    ...
    */
    function getBalance(address _address) view public returns (uint256) {
        if(joined[_address]>0)
        {
            ...
            uint256 percent = investments[_address].mul(interest).div(1000); // how much to return, step = 100 is 100% return
