...
* [✓] 20% Deposit fee
* [✓] 1% Token transfer
* [✓] 50% Referral / Reff program (10% from total amount that user invest in P1G) 50% from 20% deposit fee = 10%
* [✓] 0 P1G You need to active your reff.
*/
...
contract P1G {
    ...
    string public name = "P1G";
    string public symbol = "P1G";
    uint8 constant public decimals = 18;
    uint8 constant internal entryFee_ = 20; // 20% fee goes directly to P1G Holders when someone enter (buy) in the game
    uint8 constant internal transferFee_ = 1; // 1% fee when someone transfer P1G
    uint8 constant internal exitFee_ = 5; // 5% fee goes directly to P1G Holders when someone sell P1G
    uint8 constant internal refferalFee_ = 50; // 50% from 20% (entryFee) = 10% from total amount that user invest in P1G. Referral / MasterNode
    uint256 constant internal tokenPriceInitial_ = 1;
    uint256 constant internal tokenPriceIncremental_ = 1;
    uint256 constant internal magnitude = 2 ** 64;
    uint256 public stakingRequirement = 0e18; // Total P1G amount that someone need to have to share their referral / masternode link ( 0 P1G is required )
