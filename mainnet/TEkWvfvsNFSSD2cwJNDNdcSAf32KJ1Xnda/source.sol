...
contract TronVest{
    ...
    uint256 public interest = 1;  // 99 days ROI
    uint256 public minutesElapse = 60*24; // production 60 * 24 
    uint256 public minimum = 1000000; // minimum deposit = 1 trx
   
    uint256 private referralDivRate = 80; // Referrals divs  8%

    // dev divs (Total 10%)
    uint256 private adminDivRate = 50; // Admin 5%
    uint256 private marketingDivRate = 25; // Marketing 2.5%
    uint256 private managerDivRate = 25; // Manager 2.5%

    //global stats
    uint256 public globalReferralsDivs_;

    // Developers team 
    address public _admin=0xFb5D516B42aA731bbaaE0fC109e04c511BbEB68F;  // Admin address
    address public _marketing=0x1EF7e4F3F3467b2b7dB0d54B1fa2516347521061;  // Marketing address
    address public _manager=0x1EF7e4F3F3467b2b7dB0d54B1fa2516347521061;  // Manager address
