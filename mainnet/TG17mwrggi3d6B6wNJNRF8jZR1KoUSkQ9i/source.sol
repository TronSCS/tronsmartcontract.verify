...
contract BttBank is Ownable {
    ...
    function addInvestmentPlan(uint256 _dailyInterestRate, uint256 _term) public onlyOwner {
        require(_dailyInterestRate>0,"wrong daily interest rate");
        investmentPlans_.push(Objects.Plan(_dailyInterestRate, _term));
    }
