...
contract Trongold is TRC20 {
    ...
    uint256 public researchDivPercent = 4;
    ...
    // Constructor
    function Trongold(address schemaAddress) public payable {
        owner = msg.sender;
    ...
    function snapshotDailyGooResearchFunding() public {
        ...
        uint256 todaysGooResearchFund = (totalTronGooResearchPool * researchDivPercent) / 100; // 12% of pool daily
    ...
    function snapshotDailyGooDepositFunding() public {
        ...
        uint256 todaysGooDepositFund = (totalTronGooResearchPool * gooDepositDivPercent) / 100; // 1% of pool every 3 hours
        ...
        nextGooDepositSnapshotTime = block.timestamp + 3 hours;
    }
