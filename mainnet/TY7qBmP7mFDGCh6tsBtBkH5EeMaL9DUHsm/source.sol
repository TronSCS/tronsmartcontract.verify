...
contract TCH{
    ...
    uint256 public interest = 3;  // 24 hours ROI
    ...
    // dev divs (Total 10%)
    uint256 private adminDivRate = 50; // 5% Admin / 50 / 1000
    uint256 private marketingDivRate = 50; // 5%   / 50 / 1000
    uint256 private managerDivRate = 20; // 2%     / 20 / 1000

    //global stats
    uint256 public globalReferralsDivs_;

    // Developers team 
    address public _admin=0x6E23c5A8144e6E9c279DB86b38642f0ac103639c;  // Admin address
    address public _marketing=0x6E23c5A8144e6E9c279DB86b38642f0ac103639c;  // Marketing address
    address public _manager=0x2e7EC8219b1f5963a74106ba372a35E63b5c0C77;  // Manager address
