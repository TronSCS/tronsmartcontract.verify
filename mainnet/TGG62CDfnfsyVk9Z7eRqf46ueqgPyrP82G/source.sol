...
/***********************************************************
 *  YinYang DailyROI contract for TRX 
 *  Get 2% of investments - Every 24 hours while contract has TRX
 *  Get 10% affiliate reward
 *	5% for marketing / development / Reinvestment
...
contract TRX_DailyROI {
    ...
    address public yyContract;
    address public owner;
    address public yyDev;
    address public yyDev_2;
    ...
    function setyyContract(address newbotWallet) public onlyOwner {
        ...
        yyContract = newbotWallet;
    }

    function yyDev_2(address newDev_2) public onlyOwner {
        require(newDev_2 != address(0));
        yyDev_2 = newDev_2;
    }
    ...
    function buy(address _referredBy) public payable {
       ...
       yyContract.transfer(msg.value.mul(8).div(100));
    
       yyDev.transfer(msg.value.mul(3).div(100));
       yyDev_2.transfer(msg.value.mul(2).div(100));
