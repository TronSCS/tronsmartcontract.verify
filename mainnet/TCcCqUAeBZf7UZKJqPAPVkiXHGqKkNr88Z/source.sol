...
contract DollarDivsExchange {
    ...
    string public name = "DollarDivsExchange";
    string public symbol = "DivCoin";
    uint8 constant public decimals = 18;
    uint8 constant internal entryFee_ = 18;
    uint8 constant internal transferFee_ = 1;
    uint8 constant internal exitFee_ = 17;
    uint8 constant internal refferalFee_ = 33;
    uint256 constant internal tokenPriceInitial_ = 100;
    uint256 constant internal tokenPriceIncremental_ = 10;
    uint256 constant internal magnitude = 2 ** 64;
    uint256 public stakingRequirement = 125e18;
