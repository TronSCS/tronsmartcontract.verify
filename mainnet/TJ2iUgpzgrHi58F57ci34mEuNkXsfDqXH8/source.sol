...
/**
 * RisingROI DYNAMIC Contract
 * ROI Rises by 1% EACH DAY! Protect against early investors! Ensure contract sustainability!
...
contract Rising{
    ...
    constructor(address vault) public {
        ...
        _vault = vault;
        gameStartTime = now;
        nextIncreaseTime = gameStartTime + 24 hours;
    }
...
function checkAndIncreaseInterest() public {
    // Check to see if it's  been a day since last increase and up the interest if so.
    if (now >= nextIncreaseTime) { 
        uint _interest = interest + 10; // Add 1% interest.
        interest = _interest;
        nextIncreaseTime = now + 24 hours;
    }
}
 ...
 function getDynamicPercentage() public view returns (uint256) {
    ...
    */
    function withdraw() public returns (bool){
        ...
        // Check if we need to increase interest
        checkAndIncreaseInterest();
