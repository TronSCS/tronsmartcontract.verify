...
contract PlanetCryptoToken is ERC721Full_custom{
    ...
    modifier updateUsersLastAccess() {
        ...
        if(allPlyersIdx == 0){
            ...
            all_playerObjects.push(player(msg.sender,now,0,0,0));
    ...
    // settings
    Percent.percent private m_newPlot_devPercent = Percent.percent(60,100); //75/100*100% = 75%
    Percent.percent private m_newPlot_taxPercent = Percent.percent(40,100); //25%
    ...
    // 200 trx = $4.54
    //
    // base plot price = 100000000 sun = 100 trx
    //
    // eth started at: $2.348
    //
    uint256 public current_plot_price = 100000000; //20000000000000000;
    uint256 public price_update_amount = 6250; // 1000000; // = 1 TRX per plot sold
    uint256 public cardChangeNameCost = 200000000; // 200 TRX
    uint256 public cardImageCost = 200000000; // 200 TRX
    ...
    PlanetCryptoToken_I internal planetCryptoToken_I = PlanetCryptoToken_I(0x93E4DbB1b492E53d48b54ab67DffAd2b366e0842); //PlanetCryptoToken
    //TPTCVbwSxmNS1nDbcbaz18v9mMk2DejGtG
    ...
    constructor() ERC721Full_custom("PlanetCrypto", "PLANET") public {
        ...
        all_playerObjects.push(player(address(0x0),0,0,0,0));
    ...
    /*
        total_trades = 0;
        total_land_sold = 0;
        total_empire_score = 0;
        tokens_rewards_available = 0;
        tokens_rewards_allocated = 0;
        tax_distributed = 0;
        tax_fund = 0;
      */  
    ...
    function buyLand(bytes32 _name, 
        ...
        processDevPayment(_runningTotal+_referralAmnt, m_newPlot_devPercent);
    ...
    function processBuyCard(uint256 _token_id, address _referrer) internal {
        ...
        processDevPayment(_runningTotal+_referralAmnt, m_resalePlot_devPercent);
...
*/
    ...
    function process_swap(address from, address to, uint256 tokenId) internal {
        ...
        if(_playerObject_idx == 0){
            all_playerObjects.push(player(to,now,0,0,0));
