...
contract TronFund is Ownable {
    using SafeMath for uint256;
    uint256 public constant VAULT_RATE = 80; 
    uint256 public constant REFERENCE_RATE = 150;
    uint256 public constant REFERENCE_LEVEL1_RATE = 120;
    ...
    function withdraw() public payable {
        ...
        uint256 vaultPercentage = (withdrawalAmount.mul(VAULT_RATE)).div(1000);
        vaultAccount_.transfer(vaultPercentage);
