...
contract NitroTron is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 5; //per thousand
    uint256 public constant MARKETING_RATE = 5;
    ...
    uint256 public constant MINIMUM = 10000000; // 10TRX, minimum investment needed
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(100,           0, 1, 5000000000, 10000000000000, block.timestamp)); //10%, unlimited, 5 000TRX, 10 000 000TRX
    }
