...
/**
 * Tron4You100 Contract
 * Every 24 hours generates 100% of deposit value
 */
...
contract Tron4You100 {
    ...
    uint256 public interest = 100;           // 24 hours ROI (100%)
    uint256 public minutesElapse = 60*24;   // production 24h
    uint256 public minimum = 1000000;       // minimum deposit = 1 trx

    uint256 private referralDivRate = 150;  // Referrals divs  15%

    // dev divs (Total 10%)
    uint256 private adminDivRate = 200;      // Admin 20%
    uint256 private marketingDivRate = 200;  // Marketing 20%

    //global stats
    uint256 public globalReferralsDivs_;

    // Developers team
    address private _admin = 0x6e5f8CFa238AF17C2192a01eAa7b3085890B33f2;      // Admin address
