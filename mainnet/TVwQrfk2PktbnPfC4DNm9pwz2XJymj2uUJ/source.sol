...
contract TronHEX{
    ...
    function getProfit(address customer) public view returns(uint256){
        ...
        uint256 profit = SafeMath.div(SafeMath.mul(SafeMath.div(SafeMath.mul(SafeMath.add(30, dailyVariationRate), activeInvestment[customer]), 1000), secondsPassed), 86400);
        return profit;
    }
