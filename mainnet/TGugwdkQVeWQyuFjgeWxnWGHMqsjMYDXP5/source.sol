...
library Objects {
    ...
    struct Investor {
        ...
        uint256 level1RefInvestment;
        uint256 level2RefInvestment;
    }
}
...
contract TTT is Ownable {
    ...
    uint256 public constant DEVELOPER_RATE_25 = 25; //per thousand
    uint256 public constant DEVELOPER_RATE_20 = 20;
    uint256 public constant DEVELOPER_RATE_5 = 5;

    uint256 public constant MARKETING_RATE = 50;
    uint256 public constant REFERENCE_RATE = 60;
    ...
    uint256 public constant REFERENCE_SELF_RATE = 10;
    ...
    address private developerAccount_25;
    address private developerAccount_20;
    address private developerAccount_5;
    ...
    constructor() public {
        developerAccount_25 = msg.sender;
        developerAccount_20 = msg.sender;
        developerAccount_5 = msg.sender;
    ...
    function getDeveloperAccount_a() public view onlyAdmin returns (address) {
        return developerAccount_25;
    }

    function setDeveloperAccount_a(address _newDeveloperAccount) public onlyOwner {
        require(_newDeveloperAccount != address(0));
        developerAccount_25 = _newDeveloperAccount;
    }

    function getDeveloperAccount_b() public view onlyAdmin returns (address) {
        return developerAccount_20;
    }

    function setDeveloperAccount_b(address _newDeveloperAccount) public onlyOwner {
        require(_newDeveloperAccount != address(0));
        developerAccount_20 = _newDeveloperAccount;
    }

    function getDeveloperAccount_c() public view onlyAdmin returns (address) {
        return developerAccount_5;
    }

    function setDeveloperAccount_c(address _newDeveloperAccount) public onlyOwner {
        require(_newDeveloperAccount != address(0));
        developerAccount_5 = _newDeveloperAccount;
    }
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(0, 16, 250 * 60 * 60 * 24, true));
        //1.6
        investmentPlans_.push(Objects.Plan(1, 20, 100 * 60 * 60 * 24, true));
        //2.0
        investmentPlans_.push(Objects.Plan(2, 26, 50 * 60 * 60 * 24, true));
        //2.6
    ...
    function _invest(address _addr, uint256 _planId, uint256 _referrerCode, uint256 _amount) private returns (bool) {
        ...
        uint256 developerPercentage_25 = (_amount.mul(DEVELOPER_RATE_25)).div(1000);
        developerAccount_25.transfer(developerPercentage_25);

        uint256 developerPercentage_20 = (_amount.mul(DEVELOPER_RATE_20)).div(1000);
        developerAccount_20.transfer(developerPercentage_20);

        uint256 developerPercentage_5 = (_amount.mul(DEVELOPER_RATE_5)).div(1000);
        developerAccount_5.transfer(developerPercentage_5);
    ...
    function _withdraw() private isNotLocked returns (uint256){
    ...
    function reinvest(uint256 _planId) public payable {
        uint256 withdrawalAmount = _withdraw();
        if (withdrawalAmount >= 0) {
            if (_invest(msg.sender, _planId, 1, withdrawalAmount)) {
    ...
    function _calculateReferrerReward(uint256 _uid, uint256 _investment, uint256 _referrerCode) private {
        ...
        if (_referrerCode != 0) {
            ...
            if (_ref1 != 0) {
                ...
                uid2Investor[_ref1].level1RefInvestment = uid2Investor[_ref1].level1RefInvestment.add(_investment);
            }
            ...
            if (_ref2 != 0) {
                ...
                uid2Investor[_ref2].level2RefInvestment = uid2Investor[_ref2].level2RefInvestment.add(_investment);
            }
    ...
    function checkrefferinfo(uint256 _uid) public view onlyAdmin returns(uint256, uint256, uint256, uint256) {

        return (
            uid2Investor[_uid].level1RefCount,
            uid2Investor[_uid].level1RefInvestment,
            uid2Investor[_uid].level2RefCount,
            uid2Investor[_uid].level2RefInvestment
        );
