...
contract BTTTRON {
    ...
    uint256 public minimumInvestment = 1000000;
    ...
    function setsupport(address supportWallet) public onlyOwner {
        require(supportWallet != address(0));
        support = supportWallet;
    }

    function setmarketing(address marketingWallet) public onlyOwner {
    ...
    function buy(address _referredBy) public payable {
       ...
       support.transfer(msg.value.mul(1).div(100));
