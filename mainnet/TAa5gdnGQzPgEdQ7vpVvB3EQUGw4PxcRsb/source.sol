...
/*
* OpenNFT (ONFT)
* Initial 0.00001 trx, incremental 0.000001 trx
* 10% trading fee, 3.3% Referral, 3.3% dev fee 
* 0% transfer fee
*/
...
contract OpenNFT{
    ...
    address public _vault; // vault belong to Project team
