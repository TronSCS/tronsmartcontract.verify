...
| | | |   __|  |  |     | | | |  _| . |   |
|_|_|_|_____|_____|__|__| |_| |_| |___|_|_|
                                                                                     
                                                       
 9.9% ~ 24.9% daily ROI. Allow to withdraw every second.  
 
 It is built on TRON network and runs autonomously based on the smart contract.

 Website:    https://megatronroi.com

 Discord:    https://discord.gg/Fc4tjtw
...
contract MEGATron is Ownable {
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(99, 0)); //unlimited
        investmentPlans_.push(Objects.Plan(149, 14*60*60*24)); //14 days
        investmentPlans_.push(Objects.Plan(199, 9*60*60*24)); //9 days
        investmentPlans_.push(Objects.Plan(249, 6*60*60*24)); //6 days
    }
