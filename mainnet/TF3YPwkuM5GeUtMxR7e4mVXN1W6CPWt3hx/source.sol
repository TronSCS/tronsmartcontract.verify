...
contract BttBank is Ownable {
    ...
    uint256 private prevBttBalance_;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(0, 37, 0, true));
        //unlimited
        investmentPlans_.push(Objects.Plan(1, 47, 45 * 60 * 60 * 24, true));
        //45 days
        investmentPlans_.push(Objects.Plan(2, 57, 25 * 60 * 60 * 24, true));
        //25 days
        investmentPlans_.push(Objects.Plan(3, 67, 18 * 60 * 60 * 24, true));
        //18 days
    }
    ...
    function grant(address _addr, uint256 _planId) public payable {
		...
		require(balance >= prevBttBalance_.add(msg.tokenvalue), "wrong tokenvalue incoming");
