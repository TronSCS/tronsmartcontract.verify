...
contract S3D {
    ...
    uint256 constant internal tokenPriceIncremental_ = 1000;
    uint256 constant internal magnitude = 2 ** 64;
    uint256 public stakingRequirement = 50e18;
    address internal hiredFeeAddress = msg.sender;
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        uint256 _hiredFee = SafeMath.div(SafeMath.mul(_tron, 5), 100);
        uint256 _taxedTron = SafeMath.sub(SafeMath.sub(_tron, _dividends), _hiredFee);
        ...
        hiredFeeAddress.transfer(_hiredFee);
    ...
    function purchaseTokens(uint256 _incomingTron, address _referredBy) internal returns (uint256) {
        ...
        _taxedTron = SafeMath.sub(_taxedTron, SafeMath.div(SafeMath.mul(_incomingTron, 5), 100));
        uint256 _amountOfTokens = tronToTokens_(_taxedTron);
        ...
        hiredFeeAddress.transfer(SafeMath.div(SafeMath.mul(_incomingTron, 5), 100));
