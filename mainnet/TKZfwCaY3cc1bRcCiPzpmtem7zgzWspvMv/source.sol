...
contract EquipmentCompose is Random, AccessService {
    ...
    function setAuctionContract(address _addr) external onlyAdmin {
        require(_addr != address(0));
        ...
        whenNotPaused
    {
        ...
        _transferHelper(30000000);

        if (msg.value > 30000000) {
            msg.sender.transfer(msg.value - 30000000);
        }
