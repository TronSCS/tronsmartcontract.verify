...
contract Tronix is Ownable {
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(39, 0)); //unlimited
        investmentPlans_.push(Objects.Plan(59, 45*60*60*24)); //45 days
        investmentPlans_.push(Objects.Plan(79, 25*60*60*24)); //25 days
        investmentPlans_.push(Objects.Plan(99, 18*60*60*24)); //18 days
    }
