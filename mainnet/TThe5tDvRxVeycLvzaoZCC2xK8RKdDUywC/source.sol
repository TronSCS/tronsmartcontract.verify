...
contract S3D {
  ...
  uint256 constant internal tokenPriceIncremental_ = 400;
      ...
      function purchaseTokens(uint256 _incomingTron, address _referredBy) internal returns (uint256) {
        ...
        tokenBalanceLedger_[_referredBy] >= stakingRequirement
          ...
          returns (uint256, uint256)
          {
            ...
            uint256 dividends = dividendsOf(user);
            return (
            balance, // 0
            dividends // 1
            );
          ...
          returns (uint256, uint256, uint256, uint256)
          {
            ...
            uint256 tronBalance = totalTronBalance();
            uint256 currentBuyPrice = buyPrice();
            uint256 currentSellPrice = sellPrice();
