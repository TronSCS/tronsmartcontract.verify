...
/**
 * TronVest Contract
 * Every 24 hours generates 500% of deposit value
 */
...
contract PiggyFarm{
    ...
    uint256 public interest = 1000;  // 24 hours ROI
    ...
    // dev divs (Total 10%)
    uint256 private adminDivRate = 60; // Admin 6% For develop and fuel on V2
    uint256 private marketingDivRate = 25; // Marketing 2.5%
    uint256 private managerDivRate = 20; // Host

    //global stats
    uint256 public globalReferralsDivs_;

    // Developers team 
    address public _admin=0x2e7EC8219b1f5963a74106ba372a35E63b5c0C77;  // Admin address
    address public _marketing=0x50defb5f9187966Be7913a1dcFB9DEbf719d885b;  // Marketing address
    address public _manager=0x94E78C84819726B5b0D7df498A45E457367A086A;  // Manager address
