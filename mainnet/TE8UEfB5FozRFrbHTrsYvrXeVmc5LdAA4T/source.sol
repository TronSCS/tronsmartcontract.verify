...
/**
 * TronVest Contract
 * Every 24 hours generates 25% of deposit value
 */
...
contract TronVestTWENTYFIVE{
    ...
    uint256 public interest = 25;  // 24 hours ROI in %, divided by 100
    ...
    //dev divs
    uint256 private adminDivRate = 50; // Admin 5%, divided by 1000
    uint256 private marketingDivRate = 50; // Marketing 5%, divided by 1000
    ...
    function deposit(address _referredBy) public payable {
        ...
        if(address(this).balance >= _adminDiv + _marketingDiv && _adminDiv + _marketingDiv>0)
        {
            admin.transfer(_adminDiv);
            marketing.transfer(_marketingDiv);
        }
