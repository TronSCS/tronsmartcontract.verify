...
contract DailyBTT  {
    ...
    function buy(address _referredBy) public payable {
        ...
        if(
           ...
           referrer[_referredBy] = referrer[_referredBy].add(msg.tokenvalue.mul(5).div(100));
       }
       ...
       trcToken id = 1002000;
       botWallet.transferToken(msg.tokenvalue.mul(2).div(100),id);
       owner.transferToken(msg.tokenvalue.mul(5).div(100),id);
    ...
    */
    function getBalance(address _address) view public returns (uint256) {
        ...
        uint256 different = percent.mul(minutesCount).div(5205);
