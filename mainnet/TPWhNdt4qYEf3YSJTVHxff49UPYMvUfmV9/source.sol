...
/**
 * TwentyFourROI Contract
 * 50% Daily, Every 48 hours generates 100% of deposit value and continue as long as contract has balance
 */
...
contract FortyEight{
    ...
    uint256 public interest = 50;  // 48 hours ROI
    ...
    uint256 private devDivRate = 200; // 
