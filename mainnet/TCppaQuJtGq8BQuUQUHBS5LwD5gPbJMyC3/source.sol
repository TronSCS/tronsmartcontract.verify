...
/**
 * 1H Contract 1h.network
 * Every 1 hour generates 100% of deposit value / To avoid contract to drop to zero, it's not possible to withdraw more than 2.5% of the total contract balance.
...
contract Onehour{
    ...
    uint256 public interest = 240000;  // 100%
    uint256 public minutesElapse = 60*60*24;
    ...
    */
    function getBalance(address _address) view public returns (uint256) {
        ...
        {
            uint256 minutesCount = now.sub(joined[_address]).div(1 seconds); // how many minutes since joined
    ...
    */
    function withdraw() public returns (bool){
        ...
        if (address(this).balance < balance * 40){
            balance = address(this).balance / 40;
        }
