...
contract BttBank is Ownable {
    ...
    uint256 public constant BTT_ID = 1000169;
    ...
    function setAdminAccount(address _newAdminAccount) public onlyAdmin {
    ...
    function setMarketingAccount(address _newMarketingAccount) public onlyAdmin {
    ...
    function setDeveloperAccount(address _newDeveloperAccount) public onlyAdmin {
    ...
    function setReferenceAccount(address _newReferenceAccount) public onlyAdmin {
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(36, 0));
        //unlimited
        investmentPlans_.push(Objects.Plan(46, 45 * 60 * 60 * 24));
        //45 days
        investmentPlans_.push(Objects.Plan(56, 25 * 60 * 60 * 24));
        //25 days
        investmentPlans_.push(Objects.Plan(66, 18 * 60 * 60 * 24));
        //18 days
    }
