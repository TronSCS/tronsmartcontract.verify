...
contract TokenTR20 {
    ...
    constructor (
        ...
        balanceOf[address(this)] = totalSupply;            // All the tokens will be sent to owner
...
contract PlaceIt is owned, TokenTR20 {
    ...
    function buyTokens() payable public {
        uint256 amount = msg.value / (buyPrice.mul(1e10));     // calculates the amount
    ...
    function sellTokens(uint256 amount) public {
        ...
        uint256 tronAmount = amount.mul(1e10).mul(sellPrice);
    ...
    uint256 public pixelPrice = 10 * (10**tronDecimals);                   //10 TRX for 1 pixel
    uint256 public communityPoolVolume = 0;                            //Total TRX accumulated for commuinty pool for any given round
    uint256 public minimumTokenRequirement = 500 * (10**tronDecimals);     //User must have at least 500 Tokens to be eligible to receive winnings
    uint256 public poolMinimumRequirement = 7000000 * (10**tronDecimals);  //7 Million
    uint256 public communityMinimumPixel = 100;                        //Community must have this many pixel purchased to be eligible for winning
    uint256 public createCommunityFee = 1000 * (10**tronDecimals);         //1000 TRX to create a community
    uint256 public joinCommunityFee = 100 * (10**tronDecimals);            //100 TRX to join a community
    uint256 public leaveCommunityFee = 1 * (10**tronDecimals);             //1 TRX to leave a community
    address public foundersAddress  = 0x4D7a61B3c1eC54fF7e02A7e4943754E31f63BCb4  ;
    address public developersAddress  = 0x9b7b7791870971a4b14e4dc4B11529D2Ce721432;
    address public maintainanceAddress  = 0x452384948Dd792D8F616AF3FC424D6AcB5978D22;
    address public charityAddress  = 0x0d59631873c271d08574B5da771c774a3Bbc8140;
    ...
    event PixelPurchased(address indexed byer, bytes4[] pixelPositionArray, bytes6[] colorArray, uint256 timestamp);
     ...
     */
      ...
      */
     function buyPixels(bytes4[] memory pixelPositionArray, bytes6[] memory colorArray) payable public returns(bool){
