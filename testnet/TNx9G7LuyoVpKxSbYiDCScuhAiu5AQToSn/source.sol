...
contract iEXMultiSender is Ownable 
{
    ...
    function trxSendSameValue(address[] _to, uint _value) internal {
        ...
        emit LogMultisended(0x000000000000000000000000000000000000bEEF, msg.value);
    }
    ...
    function trxSendDifferentValue(address[] _contributors, uint256[] _balances) internal {
