 ...
 * Commissions: 5% for Orca contract, 5% for referral(if apply), and 5% for dev.
...
contract OrcaDivs{
    ...
    uint256 public interest = 400;  // 3.35% , this number is divided by 10000
    ...
    uint256 private orcaDivRate = 5; // 10% to Orca
    ...
    function deposit(address _referredBy) public payable {
        ...
        {
            orca.depositDividends.value(_orcaDiv)();
        }
